...
- Remote artifact workflow `30729993458` activated `0.1.33+gc03675b`, which
  contains the mobile touch-selection mapping fix plus follow-up lifecycle,
  Git dispatch, and Agent-history hardening.
