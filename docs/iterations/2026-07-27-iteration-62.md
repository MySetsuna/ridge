...
- 后续复核发现 standalone Remote 漏接 shared-grid 开关；`1d3a347` 修复并由 run `30272240047` 重发，`0.1.6+g1d3a347` 已原子激活。
- 再复核发现 WebGPU 降级 Canvas2D 会绕过 shared-grid 几何；`67e0631` 补齐降级路径，run `30278843596` 激活 `0.1.6+g67e0631`。
- `5f7433d` 移除公网 WebGPU 降级开关，run `30284595465` 已激活 `0.1.6+g5f7433d`。
