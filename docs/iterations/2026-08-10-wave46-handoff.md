...
- 本地 V8/LCOV：statements `12651/18603 = 68.00%`；branches `6972/11608 = 60.06%`；functions `2475/3536 = 69.99%`；lines `11412/15891 = 71.81%`。
- 本地 statements 80% 目标需 `14883` 条，当前尚缺 `2232` 条。
