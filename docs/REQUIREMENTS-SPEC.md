...
| v0.3.75 | 2026-08-05 | `<ITERATION-171-REMOTE-LINK-FLUIDITY>` | Remote validated URL/path hits now open on bare primary click, mobile Pane switching drains only a bounded live catch-up slice with resync on overflow, Cloud active-pane promotion is latest-wins, and bounded stage/latency telemetry separates input, transport, feed, and first paint | Advances `REQ-REMOTE-LINK-FLUIDITY-01`, `REQ-REMOTE-SMOOTH-STATE-02`, and `REQ-REMOTE-RUNTIME-PERF-MEMORY-02`; public/mobile soak and a new artifact release remain open; online stays `0.1.60+g42680ca` | `pnpm check` 0/0; focused Remote suite 8 files/53 passed; NLM query returned `RESOURCE_EXHAUSTED`, no note created |
