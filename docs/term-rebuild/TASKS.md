...
- 2026-05-03 — §0 进度快照「剩余主线」清单加第 4 项指向 §1.14——把上一轮新登记的 PaneState::Starting gap 纳入快照可见的 deferred / blocked-on-user 列表（与 §1.5 / §2.2 / §2.4 / §3.3 等其他 LOW / 远期项并列）。这样未来 reader 看快照即知所有未完成项目，无需深扫描全文。
