...
- 2026-05-03 — §5.2 设计核查：发现简单缩 capacity 到 256 与 push_front evict-newest 冲突，深翻历史会 evict 所有 recent 行；改 evict-oldest 也无法扩 effective scrollback。决定走方案 A（不去重，接受 ~700 KB/pane 重复），§5.2 关闭为「不做」。Round 6 实质收尾。— _pending commit_
