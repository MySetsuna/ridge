...
pub async fn load_terminal_font_faces(
    ...
    tauri::async_runtime::spawn_blocking(move || {
        resolve_terminal_font_faces(families, known_hashes.unwrap_or_default())
    })
    .await
