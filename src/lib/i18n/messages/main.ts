...
export const zh: Record<string, string> = {
  ...
  dlgDeleteSaveTitle: '删除保存记录',
  dlgDeleteSaveMessage: '该操作只会删除 .ridge 保存文件，不会关闭工作区。工作区名称将恢复为默认。确定继续？',
  dlgDeleteSaveOk: '删除',
  dlgDeleteSaveFail: '删除保存记录失败',
...
export const en: Record<string, string> = {
  ...
  dlgDeleteSaveTitle: 'Delete save record',
  dlgDeleteSaveMessage: 'This will only delete the .ridge save file, not close the workspace. The workspace name will revert to default. Continue?',
  dlgDeleteSaveOk: 'Delete',
  dlgDeleteSaveFail: 'Failed to delete save record',
