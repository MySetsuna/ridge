...
export const zh: Record<string, string> = {
  ...
  renameBranch: '重命名分支',
  renameBranchPlaceholder: '新分支名',
  deleteBranch: '删除分支',
  deleteBranchConfirm: '确定删除本地分支「{branch}」？',
  deleteBranchForce: '分支「{branch}」含未合并提交，普通删除被拒：\n{error}\n\n强制删除（-D，丢弃未合并提交）？',
  copyBranchName: '复制分支名',
  pushBranch: '推送分支',
  fetchLabel: '抓取 (Fetch)',
  rebaseOntoBranch: '将当前分支变基到此分支',
  rebaseOntoCommit: '将当前分支变基到此提交',
  rebaseTitle: '变基',
  mergeCommitIntoCurrent: '合并此提交到当前分支',
  // ─── 标签右键菜单（图谱）──────────────────────────────────────────────────
  checkoutTag: '检出标签 (detached)',
  pushTag: '推送标签',
  deleteTag: '删除标签',
  deleteTagConfirm: '确定删除本地标签「{name}」？',
  copyTagName: '复制标签名',
  // ─── Find widget（图谱搜索提交，Ctrl+F）────────────────────────────────────
  findPlaceholder: '搜索提交（消息/哈希/作者/分支/标签）',
  findNoMatch: '无匹配',
  findPrev: '上一个 (Shift+Enter)',
  findNext: '下一个 (Enter)',
  findClose: '关闭 (Esc)',
  // ─── 提交对比（Compare）────────────────────────────────────────────────────
  selectForCompare: '标记为对比基线',
  compareWithSelected: '与 {hash} 对比',
  compareTitle: '提交对比',
  // ─── Stash（贮藏）─────────────────────────────────────────────────────────
  stashSection: '贮藏',
  stashChanges: '贮藏更改',
  stashMessagePlaceholder: '贮藏说明（可选）',
  stashApply: '应用',
  stashPop: '弹出（应用并移除）',
  stashDrop: '丢弃贮藏',
  stashDropConfirm: '确定丢弃贮藏「{message}」？此操作不可撤销。',
  stashBranch: '从贮藏新建分支',
  stage: '暂存',
...
export const en: Record<string, string> = {
  ...
  deleteBranchConfirm: 'Delete local branch "{branch}"?',
  deleteBranchForce: 'Branch "{branch}" has unmerged commits; safe delete refused:\n{error}\n\nForce delete (-D, discards unmerged commits)?',
  copyBranchName: 'Copy Branch Name',
  pushBranch: 'Push Branch',
  fetchLabel: 'Fetch',
  rebaseOntoBranch: 'Rebase Current onto Branch',
  rebaseOntoCommit: 'Rebase Current onto this Commit',
  rebaseTitle: 'Rebase',
  mergeCommitIntoCurrent: 'Merge into Current Branch',
  // ─── Tag context menu (graph) ──────────────────────────────────────────────
  checkoutTag: 'Checkout Tag (detached)',
  pushTag: 'Push Tag',
  deleteTag: 'Delete Tag',
  deleteTagConfirm: 'Delete local tag "{name}"?',
  copyTagName: 'Copy Tag Name',
  // ─── Find widget (search commits in graph, Ctrl+F) ─────────────────────────
  findPlaceholder: 'Search commits (message / hash / author / ref)',
  ...
  compareWithSelected: 'Compare with {hash}',
  compareTitle: 'Compare',
  // ─── Stash ─────────────────────────────────────────────────────────────────
  stashSection: 'Stashes',
  stashChanges: 'Stash Changes',
  stashMessagePlaceholder: 'Stash message (optional)',
  stashApply: 'Apply',
  stashPop: 'Pop (apply & remove)',
  stashDrop: 'Drop Stash',
  stashDropConfirm: 'Drop stash "{message}"? This cannot be undone.',
  stashBranch: 'Branch from Stash',
  stage: 'Stage',
