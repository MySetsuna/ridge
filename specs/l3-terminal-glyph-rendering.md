...
straight-line profiles at declared cell edges while retaining native interior
curves. Their quads preserve a one-source-texel-to-one-device-pixel mapping and
clip to snapped cell bounds without geometric rescaling.
