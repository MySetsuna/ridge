---
id: L4-OBS-PACKAGES-REMOTE-SRC-SHARED-TERMINAL-PORTS-TS-c735d638
level: L4
...
Host ports provide an optional asynchronous, origin-aware file validation capability used only for a hovered path candidate. Validation shares the same request shape and cache as opening, keeping TerminalManager portable and free of filesystem dependencies.
