---
id: L4-OBS-PACKAGES-REMOTE-SRC-SHARED-TERMINAL-LINKAFFORDANCE-TS-6447eb98
level: L4
parent: L3-OBS-PACKAGES-REMOTE-SRC-SHARED-TERMINAL-b1abe747
title: linkAffordance.ts
status: LOCKED
origin: observed
...
Terminal link affordances classify only web URLs and file paths. Unsafe or unsupported OSC-8 URIs never receive pointer affordances; path targets resolve against pane CWD/workspace context before validation.
