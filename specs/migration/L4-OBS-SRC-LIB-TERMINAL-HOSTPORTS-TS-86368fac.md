---
id: L4-OBS-SRC-LIB-TERMINAL-HOSTPORTS-TS-86368fac
level: L4
...
Desktop terminal host ports resolve the captured pane origin once and expose the same origin-bound file proof to hover validation and click opening.
